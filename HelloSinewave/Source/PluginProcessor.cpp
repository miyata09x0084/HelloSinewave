...
//==============================================================================
const juce::String HelloSinewaveAudioProcessor::getName() const
{
...
const juce::String HelloSinewaveAudioProcessor::getProgramName (int index)
{
    return {};
}

void HelloSinewaveAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void HelloSinewaveAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* HelloSinewaveAudioProcessor::createEditor()
{
    return new HelloSinewaveAudioProcessorEditor (*this);
}

//==============================================================================
void HelloSinewaveAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
